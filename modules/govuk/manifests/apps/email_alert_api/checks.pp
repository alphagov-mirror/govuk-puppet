...
class govuk::apps::email_alert_api::checks(
  ...
  @@icinga::check::graphite { 'email-alert-api-warning-subscription-contents':
    ...
    critical   => '1',
    from      => '1hour',
    desc      => 'email-alert-api - unprocessed subscription contents created over 10 minutes ago (or 35 minutes ago if during publishing times)',
  ...
  @@icinga::check::graphite { 'email-alert-api-critical-subscription-contents':
    ...
    critical  => '1',
    from      => '1hour',
    desc      => 'email-alert-api - unprocessed subscription contents created over 15 minutes ago (or 50 minutes ago if during publishing times)',
    notes_url => monitoring_docs_url(email-alert-api-unprocessed-subscription-contents),
  }
}
